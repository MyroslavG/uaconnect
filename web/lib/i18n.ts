...
const categoryUk: Record<string, Pick<Category, "name" | "description">> = {
  ...
  "travel-tours": {
    name: "Подорожі та туризм",
    description:
      "Туристичні агенції, планування відпусток, тури, квитки, ретрити та супровід подорожей.",
  },
  photographers: {
    name: "Фото та відео",
    description:
      "Фотозйомка, відеозйомка, портрети, події, контент для брендів, reels і персональні сесії.",
  },
